...
export type models = `Bulliten` | `Chest` | `Lamp` | `Lamp2` | `Rock_1` | `Rock_2` | `Rock_3` | `Rock_4` | `Rock_5` | `Rock_6` | `Rock_7` | `Rock_Moss_1` | `Rock_Moss_2` | `Rock_Moss_3` | `Rock_Moss_4` | `Rock_Moss_5` | `Rock_Moss_6` | `Rock_Moss_7` | `StoneOven` | `Stove1` | `WoodenSign` | `WoodenSign2` | `WoodLog`
