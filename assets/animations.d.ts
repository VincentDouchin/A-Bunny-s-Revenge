interface Animations {
	...
	BunnyWithWeapon: `IDLE_NEW` | `RUN_ALT` | `FIGHT_ACTION1` | `HEAVYATTACK` | `CHEER` | `SLASH`

	Panda: `Assembly_End` | `Assembly_Loop` | `Assembly_Start` | `Chop_End` | `Chop_Loop` | `Chop_Start` | `Death` | `Duck` | `HitReact` | `Idle` | `Idle_Holding` | `Jump` | `Jump_Idle` | `Jump_Land` | `No` | `Pan_End` | `Pan_Loop` | `Pan_Start` | `Punch` | `Run` | `Run_Holding` | `Sitting_Eating` | `Sitting_End` | `Sitting_Idle` | `Sitting_Start` | `Sword` | `Walk` | `Walk_Holding` | `Wave` | `Yes`

	BunnyOvenPacked: `Body|OvenOpening` | `Door|OvenOpening` | `Door|Static` | `OvenOpening` | `Static`
}
