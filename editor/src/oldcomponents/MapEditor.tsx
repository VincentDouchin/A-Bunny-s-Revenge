...
// import { loadImageFile, saveImage } from '../lib/fileOperations'
...
// 	createEffect(on(selectedLevel, async (level) => {
// 		if (level) {
// 			const img = await loadImageFile(level, name)
// 			const finalCtxValue = finalCtx()
// 			if (img && finalCtxValue) {
// 				finalCtxValue.drawImage(img, 0, 0, img.width, img.height)
// 				setCanvas(finalCtxValue.canvas)
// 			}
// 		}
// 	}))
...
// 				const url = finalContextValue.canvas.toDataURL()
// 				modifyMutable(history, reconcile([url]))
