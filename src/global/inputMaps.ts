...
export const playerInputMap = () => {
	...
	map.get('lookRight').setAxes(GAMEPAD_AXIS.RIGHT_X, 1).setMouseWheel(MOUSE_WHEEL.Y, 1).setKeys('ArrowRight')
	map.get('lookLeft').setAxes(GAMEPAD_AXIS.RIGHT_X, -1).setMouseWheel(MOUSE_WHEEL.Y, -1).setKeys('ArrowLeft')
