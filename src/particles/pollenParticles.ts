...
export const pollenBundle = (_colorStart: ColorRepresentation, _colorEnd: ColorRepresentation) => {
	...
	// 			new Gradient(
	// 				[
	// 					[new Vector3(...new Color(colorStart).toArray()), 1],
	// 					[new Vector3(...new Color(colorEnd).toArray()), 1],
	// 				],
	// 				[
	// 					[0, 0],
	// 					[1, 0.5],
	...
	return {} as const satisfies Entity
}
