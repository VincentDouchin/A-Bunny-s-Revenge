...
export const honeySplatParticlesBundle = () => {
	...
	return { autoDestroy: true } as const satisfies Entity
}
...
export const honeyDrippingParticles = () => {
	...
	// 	behaviors: [new ApplyForce(new Vector3(0, -1, 0), new IntervalValue(1, 2)), new SizeOverLife(new PiecewiseBezier([[new Bezier(1, 0.75, 0.5, 0.25), 0]]))],
	// })
	// system.emitter.rotateX(Math.PI / 2)
