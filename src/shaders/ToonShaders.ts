...
export const ToonShader1 = (baseColor: Color) => ({
...
export const ToonShader2 = (baseColor: Color) => ({
...
export const ToonShaderHatching = (baseColor: Color) => ({
...
export const ToonShaderDotted = (baseColor: Color) => ({
