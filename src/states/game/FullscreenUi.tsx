...
export const isStandalone = () => {
	return ['fullscreen', 'standalone', 'minimal-ui'].some((displayMode) => window.matchMedia(`(display-mode: ${displayMode})`).matches) || '__TAURI__' in window
}
			...
			<Show when={show()}>
				<div
					style={{
						...
						'box-shadow': '0rem 0.5rem 0.5rem 0 hsl(0,0%,0%,50%)',
					}}
				>
