			...
			{(oven) => {
				...
				ui.updateSync(() => {
					...
					if (output()) {
						...
						if (progress() >= 100) {
							setProgress(0)
							playSound('zapsplat_foley_heavy_flat_stone_very_sort_drag_scrape_002_87118', { volume: 0.2 })
							oven.ovenAnimator.playClamped('Opening').then(async () => {
								...
								await sleep(500)
								playSound('zapsplat_foley_rubble_rock_drop_onto_pile_others_medium_sized_006_108147', { volume: 0.2 })
